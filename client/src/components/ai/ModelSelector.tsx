...
export function ModelSelector({
  ...
  const modelOptions = [
    ...
    },
    {
      value: "gpt-5.4",
      label: "GPT-5.4",
      description: "OpenAI's frontier model for procedures, technical documentation, and deep reasoning",
    ...
    },
    {
      ...
      description: "Anthropic's long-context model for deep analysis, detailed policies, and large evidence sets",
