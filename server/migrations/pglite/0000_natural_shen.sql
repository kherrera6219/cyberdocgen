...
CREATE TABLE "agent_message_inbox" (
	...
	"recipient_agent" varchar NOT NULL,
...
CREATE TABLE "evidence_control_mappings" (
	...
	"organization_id" varchar NOT NULL,
	"mapped_by" varchar,
	"mapping_source" varchar DEFAULT 'manual' NOT NULL,
	"confidence_score" numeric(5, 2),
	"status" varchar DEFAULT 'active' NOT NULL,
	"notes" text,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "evidence_control_mappings_evidence_id_framework_control_id_unique" UNIQUE("evidence_id","framework","control_id")
);
--> statement-breakpoint
...
ALTER TABLE "policy_acknowledgments" ADD CONSTRAINT "policy_acknowledgments_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
