...
export const frameworkTemplates: Record<string, DocumentTemplate[]> = {
  ...
  "Board-Governance": [
    { title: "Cybersecurity Board Report Template", description: "Quarterly/annual cybersecurity posture report to board", category: "board-report", priority: 1 },
    { title: "Compliance Status Board Memorandum", description: "Multi-framework compliance status update for directors", category: "board-memo", priority: 2 },
    { title: "Data Breach Board Notification", description: "Incident notification and response briefing for board", category: "board-memo", priority: 3 },
    { title: "Risk Management Board Dashboard", description: "Executive risk metrics and KRI reporting", category: "board-report", priority: 4 },
    { title: "Audit Committee Charter", description: "Audit committee responsibilities and governance", category: "charter", priority: 5 },
    { title: "Cybersecurity Committee Charter", description: "Board-level security committee structure", category: "charter", priority: 6 },
    { title: "Privacy Committee Charter", description: "Data protection governance committee", category: "charter", priority: 7 },
    { title: "Board Cybersecurity Education Program", description: "Director training and awareness materials", category: "training", priority: 8 },
    { title: "Annual Compliance Certification to Board", description: "CEO/CISO compliance attestation template", category: "certification", priority: 9 },
    { title: "Third-Party Risk Board Summary", description: "Vendor risk exposure executive summary", category: "board-report", priority: 10 },
    { title: "Regulatory Update Board Briefing", description: "New regulation impact analysis for directors", category: "board-memo", priority: 11 },
    { title: "Cyber Insurance Coverage Review", description: "Insurance adequacy and gap analysis", category: "board-report", priority: 12 },
    { title: "Business Continuity Board Assurance", description: "BC/DR readiness and testing results", category: "board-report", priority: 13 },
    { title: "AI Governance Board Update", description: "AI system oversight and risk management", category: "board-memo", priority: 14 },
    { title: "Privacy Impact Board Summary", description: "GDPR/CCPA compliance and risk exposure", category: "board-report", priority: 15 }
  ],
  "SOP-Security": [
    { title: "Security Incident Response SOP", description: "Step-by-step incident handling procedures", category: "sop", priority: 1 },
    { title: "Access Request and Provisioning SOP", description: "User access lifecycle management", category: "sop", priority: 2 },
    { title: "Access Review and Recertification SOP", description: "Periodic access rights validation", category: "sop", priority: 3 },
    { title: "Privileged Account Management SOP", description: "Admin account creation, monitoring, and termination", category: "sop", priority: 4 },
    { title: "Password and Credential Management SOP", description: "Password standards and reset procedures", category: "sop", priority: 5 },
    { title: "Multi-Factor Authentication Enrollment SOP", description: "MFA setup and troubleshooting", category: "sop", priority: 6 },
    { title: "Security Patch Management SOP", description: "Vulnerability remediation and patching", category: "sop", priority: 7 },
    { title: "Vulnerability Scanning SOP", description: "Regular security assessment procedures", category: "sop", priority: 8 },
    { title: "Penetration Testing SOP", description: "Annual pen test planning and execution", category: "sop", priority: 9 },
    { title: "Security Log Review SOP", description: "SIEM monitoring and log analysis", category: "sop", priority: 10 },
    { title: "Firewall Change Request SOP", description: "Firewall rule review and approval", category: "sop", priority: 11 },
    { title: "Security Exception Request SOP", description: "Risk acceptance and compensating controls", category: "sop", priority: 12 },
    { title: "Encryption Key Management SOP", description: "Key generation, rotation, and destruction", category: "sop", priority: 13 },
    { title: "Security Awareness Training SOP", description: "Annual training and phishing simulation", category: "sop", priority: 14 },
    { title: "Secure Code Review SOP", description: "Application security testing procedures", category: "sop", priority: 15 }
  ],
  "SOP-Privacy": [
    { title: "Data Subject Access Request (DSAR) SOP", description: "GDPR/CCPA request handling workflow", category: "sop", priority: 1 },
    { title: "Right to Erasure (Deletion) SOP", description: "Data deletion request processing", category: "sop", priority: 2 },
    { title: "Consent Collection and Management SOP", description: "Valid consent procedures", category: "sop", priority: 3 },
    { title: "Privacy Impact Assessment SOP", description: "DPIA/PIA trigger and completion", category: "sop", priority: 4 },
    { title: "Data Breach Notification SOP", description: "72-hour breach notification procedures", category: "sop", priority: 5 },
    { title: "Third-Party Data Processor Onboarding SOP", description: "DPA execution and due diligence", category: "sop", priority: 6 },
    { title: "Data Retention and Disposal SOP", description: "Automated retention and secure deletion", category: "sop", priority: 7 },
    { title: "Cookie Consent Management SOP", description: "Website cookie banner and preferences", category: "sop", priority: 8 },
    { title: "Privacy Notice Update SOP", description: "Privacy policy revision and notification", category: "sop", priority: 9 },
    { title: "Data Transfer Assessment SOP", description: "International transfer risk evaluation", category: "sop", priority: 10 }
  ],
  "SOP-Compliance": [
    { title: "Compliance Monitoring and Testing SOP", description: "Control testing and evidence collection", category: "sop", priority: 1 },
    { title: "Internal Audit Scheduling SOP", description: "Annual audit planning and scoping", category: "sop", priority: 2 },
    { title: "Corrective Action Plan SOP", description: "Audit finding remediation tracking", category: "sop", priority: 3 },
    { title: "Policy Review and Approval SOP", description: "Annual policy update workflow", category: "sop", priority: 4 },
    { title: "Risk Assessment SOP", description: "Annual risk identification and rating", category: "sop", priority: 5 },
    { title: "Vendor Risk Assessment SOP", description: "Third-party security evaluation", category: "sop", priority: 6 },
    { title: "Change Management SOP", description: "IT change approval and rollback", category: "sop", priority: 7 },
    { title: "Document Control SOP", description: "Version control and distribution", category: "sop", priority: 8 },
    { title: "Regulatory Notification SOP", description: "Regulator communication procedures", category: "sop", priority: 9 },
    { title: "Compliance Training Assignment SOP", description: "Required training tracking and escalation", category: "sop", priority: 10 }
  ],
  "SOP-Operations": [
    { title: "Backup and Recovery SOP", description: "Daily backup and restoration procedures", category: "sop", priority: 1 },
    { title: "Business Continuity Activation SOP", description: "BC plan invocation and escalation", category: "sop", priority: 2 },
    { title: "Disaster Recovery Testing SOP", description: "Annual DR test and validation", category: "sop", priority: 3 },
    { title: "Asset Inventory Management SOP", description: "IT asset discovery and tracking", category: "sop", priority: 4 },
    { title: "Secure Disposal of Equipment SOP", description: "Data sanitization and physical destruction", category: "sop", priority: 5 },
    { title: "Cloud Resource Provisioning SOP", description: "AWS/Azure resource deployment", category: "sop", priority: 6 },
    { title: "Mobile Device Management SOP", description: "BYOD enrollment and remote wipe", category: "sop", priority: 7 },
    { title: "Remote Access VPN SOP", description: "VPN access request and monitoring", category: "sop", priority: 8 },
    { title: "Data Classification and Labeling SOP", description: "Information sensitivity marking", category: "sop", priority: 9 },
    { title: "Physical Access Badge Management SOP", description: "Badge issuance and deactivation", category: "sop", priority: 10 }
  ],
  "Internal-Policies": [
    { title: "Acceptable Use Policy (AUP)", description: "Employee IT usage guidelines", category: "policy", priority: 1 },
    { title: "Remote Work Security Policy", description: "Work-from-home security requirements", category: "policy", priority: 2 },
    { title: "Bring Your Own Device (BYOD) Policy", description: "Personal device usage standards", category: "policy", priority: 3 },
    { title: "Clean Desk Policy", description: "Workspace security requirements", category: "policy", priority: 4 },
    { title: "Email and Communication Policy", description: "Business email and messaging guidelines", category: "policy", priority: 5 },
    { title: "Social Media Policy", description: "Corporate social media usage", category: "policy", priority: 6 },
    { title: "Data Classification Policy", description: "Information sensitivity standards", category: "policy", priority: 7 },
    { title: "Visitor Management Policy", description: "Guest access and escort procedures", category: "policy", priority: 8 },
    { title: "Vendor Access Policy", description: "Third-party system access controls", category: "policy", priority: 9 },
    { title: "Termination and Offboarding Policy", description: "Employee separation security procedures", category: "policy", priority: 10 },
    { title: "Code of Conduct", description: "Employee ethical and professional standards", category: "policy", priority: 11 },
    { title: "Whistleblower Policy", description: "Anonymous reporting procedures", category: "policy", priority: 12 },
    { title: "Conflict of Interest Policy", description: "Employee disclosure requirements", category: "policy", priority: 13 },
    { title: "Travel Security Policy", description: "International travel data protection", category: "policy", priority: 14 },
    { title: "AI Acceptable Use Policy", description: "Generative AI usage guidelines", category: "policy", priority: 15 }
  ],
  "Employee-Guides": [
    { title: "Security Awareness Employee Handbook", description: "User-friendly security guide for all staff", category: "handbook", priority: 1 },
    { title: "Privacy Quick Reference Guide", description: "GDPR/CCPA rights for employees", category: "guide", priority: 2 },
    { title: "Phishing Recognition Guide", description: "How to identify and report phishing", category: "guide", priority: 3 },
    { title: "Password Best Practices Guide", description: "Strong password creation tips", category: "guide", priority: 4 },
    { title: "Secure Remote Work Guide", description: "Home office security checklist", category: "guide", priority: 5 },
    { title: "Data Handling Guide", description: "Protecting sensitive information", category: "guide", priority: 6 },
    { title: "Incident Reporting Guide", description: "How and when to report security issues", category: "guide", priority: 7 },
    { title: "Physical Security Guide", description: "Office security and tailgating prevention", category: "guide", priority: 8 },
    { title: "BYOD Setup Guide", description: "Personal device enrollment instructions", category: "guide", priority: 9 },
    { title: "Ransomware Prevention Guide", description: "Avoiding and responding to ransomware", category: "guide", priority: 10 }
  ],
  "Operational-Documents": [
    { title: "Security Incident Response Playbook", description: "Detailed response procedures by incident type", category: "playbook", priority: 1 },
    { title: "Ransomware Response Playbook", description: "Step-by-step ransomware containment", category: "playbook", priority: 2 },
    { title: "Data Breach Response Playbook", description: "Breach investigation and notification", category: "playbook", priority: 3 },
    { title: "DDoS Attack Response Playbook", description: "Distributed denial of service mitigation", category: "playbook", priority: 4 },
    { title: "Insider Threat Response Playbook", description: "Malicious insider investigation", category: "playbook", priority: 5 },
    { title: "Risk Register Template", description: "Centralized risk tracking and treatment", category: "register", priority: 6 },
    { title: "Control Testing Schedule", description: "Annual compliance testing calendar", category: "schedule", priority: 7 },
    { title: "Vendor Risk Assessment Questionnaire", description: "Third-party security evaluation", category: "questionnaire", priority: 8 },
    { title: "Business Impact Analysis Worksheet", description: "BIA data collection template", category: "worksheet", priority: 9 },
    { title: "Asset Inventory Spreadsheet", description: "IT asset tracking database", category: "inventory", priority: 10 },
    { title: "Compliance Gap Analysis Template", description: "Framework gap identification", category: "analysis", priority: 11 },
    { title: "Security Metrics Dashboard", description: "KPI tracking and visualization", category: "dashboard", priority: 12 },
    { title: "Audit Evidence Collection Checklist", description: "SOC 2/ISO audit preparation", category: "checklist", priority: 13 },
    { title: "Third-Party Contract Addendum", description: "Security and privacy requirements", category: "contract", priority: 14 },
    { title: "Security Requirements for Procurement", description: "Vendor selection security criteria", category: "requirements", priority: 15 }
  ],
  "Training-Materials": [
    { title: "Security Awareness Training Modules", description: "Annual mandatory training curriculum", category: "training", priority: 1 },
    { title: "Phishing Simulation Campaign", description: "Simulated phishing test and remediation", category: "training", priority: 2 },
    { title: "Privacy Training for Employees", description: "GDPR/CCPA awareness program", category: "training", priority: 3 },
    { title: "Secure Coding Training", description: "Developer security best practices", category: "training", priority: 4 },
    { title: "Incident Response Tabletop Exercise", description: "Scenario-based response training", category: "training", priority: 5 },
    { title: "Social Engineering Awareness", description: "Manipulation tactics recognition", category: "training", priority: 6 },
    { title: "Cloud Security Training", description: "AWS/Azure security fundamentals", category: "training", priority: 7 },
    { title: "PCI DSS Training for Staff", description: "Payment security awareness", category: "training", priority: 8 },
    { title: "HIPAA Training for Healthcare Staff", description: "PHI protection requirements", category: "training", priority: 9 },
    { title: "Insider Threat Awareness", description: "Recognizing and reporting suspicious activity", category: "training", priority: 10 },
    { title: "Data Classification Training", description: "Proper data handling procedures", category: "training", priority: 11 },
    { title: "Mobile Security Training", description: "Smartphone and tablet security", category: "training", priority: 12 },
    { title: "Third-Party Risk Management Training", description: "Vendor oversight procedures", category: "training", priority: 13 },
    { title: "Business Continuity Awareness", description: "Employee BC/DR responsibilities", category: "training", priority: 14 },
    { title: "AI Security and Ethics Training", description: "Responsible AI usage", category: "training", priority: 15 }
  ],
  "Management-Reports": [
    { title: "Monthly Security Metrics Report", description: "KPI tracking and trend analysis", category: "report", priority: 1 },
    { title: "Quarterly Compliance Status Report", description: "Multi-framework compliance dashboard", category: "report", priority: 2 },
    { title: "Annual Risk Assessment Report", description: "Enterprise risk landscape", category: "report", priority: 3 },
    { title: "Vendor Risk Summary Report", description: "Third-party risk exposure", category: "report", priority: 4 },
    { title: "Security Incident Summary", description: "Monthly incident statistics", category: "report", priority: 5 },
    { title: "Vulnerability Management Report", description: "Patch status and critical vulnerabilities", category: "report", priority: 6 },
    { title: "Access Review Completion Report", description: "User access certification status", category: "report", priority: 7 },
    { title: "Training Completion Report", description: "Employee training compliance", category: "report", priority: 8 },
    { title: "Audit Findings Remediation Status", description: "Open findings and target closure dates", category: "report", priority: 9 },
    { title: "Privacy Metrics Report", description: "DSAR volume and response times", category: "report", priority: 10 },
    { title: "Business Continuity Testing Results", description: "DR test success criteria", category: "report", priority: 11 },
    { title: "Security Budget and Spending", description: "Security program financial tracking", category: "report", priority: 12 },
    { title: "Threat Intelligence Briefing", description: "Industry-specific threat landscape", category: "report", priority: 13 },
    { title: "Cloud Security Posture Report", description: "AWS/Azure compliance status", category: "report", priority: 14 },
    { title: "Zero Trust Implementation Progress", description: "Maturity advancement tracking", category: "report", priority: 15 }
  ],
  "Framework-Specific-Internal": [
    { title: "HIPAA Employee Acknowledgment Form", description: "Annual HIPAA training attestation", category: "form", priority: 1 },
    { title: "PCI DSS Self-Assessment Questionnaire (SAQ)", description: "Internal merchant SAQ completion", category: "questionnaire", priority: 2 },
    { title: "SOC 2 Readiness Assessment", description: "Pre-audit gap analysis", category: "assessment", priority: 3 },
    { title: "ISO 27001 Statement of Applicability (SoA)", description: "Control selection justification", category: "statement", priority: 4 },
    { title: "FedRAMP Continuous Monitoring Plan", description: "Ongoing authorization maintenance", category: "plan", priority: 5 },
    { title: "GDPR Records of Processing Activities (RoPA)", description: "Article 30 internal documentation", category: "record", priority: 6 },
    { title: "NIST CSF Current Profile", description: "As-is cybersecurity capability", category: "profile", priority: 7 },
    { title: "NIST CSF Target Profile", description: "Desired cybersecurity state", category: "profile", priority: 8 },
    { title: "PCI DSS Cardholder Data Flow Diagram", description: "CHD system mapping", category: "diagram", priority: 9 },
    { title: "CCPA Consumer Request Log", description: "Privacy request tracking", category: "log", priority: 10 },
    { title: "NIS2 Essential Entity Registration", description: "Regulatory registration documentation", category: "registration", priority: 11 },
    { title: "ISO 42001 AI System Inventory", description: "AI/ML system catalog", category: "inventory", priority: 12 },
    { title: "AWS Well-Architected Review Findings", description: "Architecture improvement plan", category: "findings", priority: 13 },
    { title: "Zero Trust Maturity Scorecard", description: "Pillar-by-pillar assessment", category: "scorecard", priority: 14 },
    { title: "Business Associate Agreement (BAA) Register", description: "HIPAA BAA tracking", category: "register", priority: 15 }
  ]
};
