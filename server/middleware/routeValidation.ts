...
export const API_ROUTES: RouteInfo[] = [
  ...
  { path: '/api/auth/temp-login', method: 'POST', requiresAuth: false, requiresMfa: false, rateLimitTier: 'high' },
  { path: '/api/auth/temp-logout', method: 'POST', requiresAuth: false, requiresMfa: false, rateLimitTier: 'low' },
